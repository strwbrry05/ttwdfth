# ttwdfth (tiktok went down for twelve hours)
[2025] A web focused page (HTML/CSS/JS) dedicated to archiving the creator's favorite tiktoks in leiu of the first massive tiktok shutdown of 2025. Each category contains its own set of videos along with functional controls for moving between and pausing said videos. Page is, additionally, responsive, with a completely different look depending on if the user is on a mobile device or a larger screen.

![Home](ttwdfth_files/ttwdfthGIF.gif)
...
<img src="ttwdfth_files/media_paused.png" width="250"/>
</span>
